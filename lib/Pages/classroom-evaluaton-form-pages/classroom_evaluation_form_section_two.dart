...
import 'package:woxsen/Pages/classroom-evaluaton-form-pages/classroom_evaluation_form_section_three.dart';
import 'package:woxsen/providers/feedback_from_provider.dart';

class ClassroomEvaluationFormSectionTwo extends StatefulWidget {
  const ClassroomEvaluationFormSectionTwo({Key? key}) : super(key: key);

  @override
  State<ClassroomEvaluationFormSectionTwo> createState() =>
      _EvaluationFormState();
}

class _EvaluationFormState extends State<ClassroomEvaluationFormSectionTwo> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildQuestionSection(
                    '1. The instructor Effectively utilized classroom facilities and technology',
                    provider.sections['section2']!['q1'],
                    (value) => provider.updateSection('section2', 'q1', value!),
                    // (value) => setState(() => _question1Response = value),
                  ),
                  const SizedBox(height: 24),
                  _buildQuestionSection(
                    '2. The classroom environment was conductive to Learning (lightning, seating, audio-Visual Aids, etc.)',
                    provider.sections['section2']!['q2'],
                    // (value) => setState(() => _question2Response = value),
                    (value) => provider.updateSection('section2', 'q2', value!),
                  ),
